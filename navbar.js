function navbar(){
    ...
    <div id="underdiv22">
         ...
         <div class="submenu1">
            <div id="subline1">
               <h6>FACE MAKEUP</h6>
                ...
                <p><a href="/topbrands.html">eyelink</a></p>
            </div>
            <div id="subline2">
                <h6>HAIR CARE</h6>
                <p><a href="hairstyle.html">hairdye</a></p>
            ...
            <div id="subline2">
                ...
                <p><a href="/facemake.html">eyeliner</a></p>
                ...
                <p><a href="/facemake.html">sharpener</a></p>
            ...
            <div id="subline2">
                <h6>LIP MAKEUP</h6>
                <p><a href="/datalipstick.html">lipstick</a></p>
                <p><a href="/datalipstick.html">lipgloss</a></p>
                <p><a href="/datalipstick.html">liquid lipstick</a></p>
        ...
        <div id="submenubrand">
            <div id="subline12">
                ...
                <p>maybelline</p>
                 ...
                 <p><a href="/foundation.html">mac</a></p>
        ...
        <div class="para4" id="hoverpara">SPLURGE</div>
        <div class="para5" id="hoverpara">MAGAZINE</div>
      ...
      <p id="fontawesome"> <i class="fas fa-search"></i></p>
       ...
       <div id="signin">
        ...
        <div id="signindiv">
            ...
            <p class="para">become a seller?<a href="" style="color: #ff147b;">Rgister now</a></p> </p>
    
        </div>
       </div>
        
      <p id="fontawesome"><i class="fas fa-chart-bar"></i></p> 
      
      <a id="fontawesome" href="addcart.html"><i class="fas fa-shopping-cart"></i></a>
...
function footer(){
    ...
    <div class="row">
        ...
        <div class="footer-col">
          <h4>PURPLLE BUSINESS</h4>
          <ul>
            <li><a href="#">Sell on Purplle</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4>POLICY INFO</h4>
          <ul>
            ...
            <li><a href="#">Returns & Cancellation Policy</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4>NEED HELP?</h4>
